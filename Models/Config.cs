...
public partial class defa {
    ...
    public static partial class Config
    {
        ...
        // Product version
        public const string ProductVersion = "20.7.0";

        // Project
        public const string ProjectNamespace = "ASPNETMaker2023";

        public const string ProjectClassName = "ASPNETMaker2023.Models.defa"; // DN
        ...
        public const string ProjectName = "defa"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{A82BC683-C15E-40D7-94E1-955AFED823D6}"; // Project ID (GUID)

        public static string RandomKey = "S8OOWvtL9pAlbh3z"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/defa.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string SidebarClass = "main-sidebar sidebar-light-primary elevation-1"; // CSS class(es) for sidebar

        public static string NavbarClass = "main-header navbar navbar-expand navbar-white navbar-light"; // CSS class(es) for navbar
        ...
        public static List<dynamic> LanguageFile = new ()
        {
            ...
            new { Id = "id-ID", File = "indonesian.xml" }
        };
        ...
        // Export Log
        public static string ExportPath = "export-a82bc683-c15e-40d7-94e1-955afed823d6"; // Export folder
        ...
        public static string AdminUserName = "User"; // Administrator user name

        public static string AdminPassword = "Password"; // Administrator password
        ...
        public static string LoginUsernameFieldName = "Email";

        public static string LoginPasswordFieldName = "Password";
        ...
        public static string UserTable = "dbo.[User]";

        public static string UserNameFilter = "([Email] = '%u')";
        ...
        {
            new object[] { 3, "mi_Dashboard", "3", "Dashboard", -1, "", "{A82BC683-C15E-40D7-94E1-955AFED823D6}Dashboard", false, false, "", "", false, true }
        };
