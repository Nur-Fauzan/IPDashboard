...
public partial class defa {
    ...
    public class LoginBase : User2
    {
        ...
        public DbField<SqlDbType> LoginUsername = new ("User2", "username", 202, SqlDbType.NVarChar) {
                TableName = "User",
                Name = "username",
                Expression = "username"
            }; // DN

        public DbField<SqlDbType> LoginPassword = new ("User2", "password", 202, SqlDbType.NVarChar) {
                TableName = "User",
                Name = "password",
                Expression = "password"
            }; // DN

        public DbField<SqlDbType> LoginType = new ("User2", "type", 202, SqlDbType.NVarChar) {
                TableName = "User",
                Name = "logintype",
