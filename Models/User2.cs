...
public partial class defa {
    ...
    {
        get => HttpData.Resolve<User2>("User2");
        set => HttpData["User2"] = value;
    }

    /// <summary>
    /// Table class for User
    /// </summary>
    public class User2 : DbTable, IQueryFactory
    {
        ...
        public User2()
        {
            ...
            Name = "User";
            Type = "TABLE";
            UpdateTable = "dbo.[User]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // ID
            ID = new (this, "x_ID", 130, SqlDbType.NChar) {
                Name = "ID",
                Expression = "[ID]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ID]",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("User2", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // Email
            _Email = new (this, "x__Email", 130, SqlDbType.NChar) {
                Name = "Email",
                Expression = "[Email]",
                UseBasicSearch = true,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("User2", "_Email", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Email", _Email);

            // Password
            Password = new (this, "x_Password", 130, SqlDbType.NChar) {
                Name = "Password",
                Expression = "[Password]",
                UseBasicSearch = true,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("User2", "Password", "CustomMsg"),
                IsUpload = false
            };
            ...
            // FullName
            FullName = new (this, "x_FullName", 130, SqlDbType.NChar) {
                Name = "FullName",
                Expression = "[FullName]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("User2", "FullName", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FullName", FullName);

            // UserLevelID
            UserLevelID = new (this, "x_UserLevelID", 130, SqlDbType.NChar) {
                Name = "UserLevelID",
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("User2", "UserLevelID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "User2View"))
                return Language.Phrase("View");
            else if (SameString(pageName, "User2Edit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "User2Add"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "User2View",
                Config.ApiAddAction => "User2Add",
                Config.ApiEditAction => "User2Edit",
                Config.ApiDeleteAction => "User2Delete",
                Config.ApiListAction => "User2List",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "User2List";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("User2View", parm);
            else
                url = KeyUrl("User2View", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "User2Add";
        ...
        {
            string url = "";
            url = KeyUrl("User2Edit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("User2List", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("User2Add", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("User2List", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("User2Delete")); // DN
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!ID.Raw)
                ID.CurrentValue = HtmlDecode(ID.CurrentValue);
            ID.EditValue = HtmlEncode(ID.CurrentValue);
            ...
            if (!UserLevelID.Raw)
                UserLevelID.CurrentValue = HtmlDecode(UserLevelID.CurrentValue);
            UserLevelID.EditValue = HtmlEncode(UserLevelID.CurrentValue);
