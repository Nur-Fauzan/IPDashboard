...
public partial class defa {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(defa).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(defa).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
    ...
    // User Table
    public static User2 UserTable
    {
        get => HttpData.Get<User2>("USER_TABLE")!;
