...
public partial class defa {
    ...
    /// cctv2Delete
    /// </summary>
    public static Cctv2Delete cctv2Delete
    {
        get => HttpData.Get<Cctv2Delete>("cctv2Delete")!;
        set => HttpData["cctv2Delete"] = value;
    }

    /// <summary>
    /// Page class for CCTV
    /// </summary>
    public class Cctv2Delete : Cctv2DeleteBase
    {
        // Constructor
        public Cctv2Delete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public Cctv2Delete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class Cctv2DeleteBase : Cctv2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "cctv2Delete";
        ...
        // Page name
        public string PageName => "Cctv2Delete";
        ...
        // Constructor
        public Cctv2DeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("Cctv2List"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("Cctv2List"); // Return to list
                }
            }
