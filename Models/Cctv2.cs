...
public partial class defa {
    ...
    /// </summary>
    [MaybeNull]
    public static Cctv2 cctv2
    {
        get => HttpData.Resolve<Cctv2>("CCTV2");
        set => HttpData["CCTV2"] = value;
    }

    /// <summary>
    /// Table class for CCTV
    /// </summary>
    public class Cctv2 : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Code;

        public readonly DbField<SqlDbType> _Name;

        public readonly DbField<SqlDbType> Loc;

        public readonly DbField<SqlDbType> Status;

        public readonly DbField<SqlDbType> Incident;
        ...
        public readonly DbField<SqlDbType> UpdatedByUserID;

        public readonly DbField<SqlDbType> Perbaikan;
        ...
        public Cctv2()
        {
            ...
            Name = "CCTV";
            Type = "TABLE";
            UpdateTable = "dbo.CCTV"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("CCTV2", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // Code
            Code = new (this, "x_Code", 202, SqlDbType.NVarChar) {
                Name = "Code",
                Expression = "[Code]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Code]",
                DateTimeFormat = -1,
                VirtualExpression = "[Code]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CCTV2", "Code", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Name = new (this, "x__Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Name", _Name);

            // Loc
            Loc = new (this, "x_Loc", 202, SqlDbType.NVarChar) {
                Name = "Loc",
                Expression = "[Loc]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Loc]",
                DateTimeFormat = -1,
                VirtualExpression = "[Loc]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "Loc", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Loc", Loc);

            // Status
            Status = new (this, "x_Status", 11, SqlDbType.Bit) {
                Name = "Status",
                Expression = "[Status]",
                ...
                CustomMessage = Language.FieldPhrase("CCTV2", "Status", "CustomMsg"),
                IsUpload = false
            };
            Status.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(Status, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(Status, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Status, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Status", Status);

            // Incident
            Incident = new (this, "x_Incident", 3, SqlDbType.Int) {
                Name = "Incident",
                Expression = "[Incident]",
                BasicSearchExpression = "CAST([Incident] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Incident]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("CCTV2", "Incident", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Incident", Incident);

            // CreatedDateTime
            CreatedDateTime = new (this, "x_CreatedDateTime", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedByUserID = new (this, "x_CreatedByUserID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "CreatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("CreatedByUserID", CreatedByUserID);

            // UpdatedDateTime
            UpdatedDateTime = new (this, "x_UpdatedDateTime", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "UpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UpdatedDateTime", UpdatedDateTime);

            // UpdatedByUserID
            UpdatedByUserID = new (this, "x_UpdatedByUserID", 3, SqlDbType.Int) {
                Name = "UpdatedByUserID",
                Expression = "[UpdatedByUserID]",
                BasicSearchExpression = "CAST([UpdatedByUserID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[UpdatedByUserID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "UpdatedByUserID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UpdatedByUserID", UpdatedByUserID);

            // Perbaikan
            Perbaikan = new (this, "x_Perbaikan", 11, SqlDbType.Bit) {
                Name = "Perbaikan",
                Expression = "[Perbaikan]",
                BasicSearchExpression = "[Perbaikan]",
                DateTimeFormat = -1,
                VirtualExpression = "[Perbaikan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("CCTV2", "Perbaikan", "CustomMsg"),
                IsUpload = false
            };
            Perbaikan.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(Perbaikan, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(Perbaikan, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Perbaikan, "CCTV2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Perbaikan", Perbaikan);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Code.DbValue = row["Code"]; // Set DB value only
                _Name.DbValue = row["Name"]; // Set DB value only
                Loc.DbValue = row["Loc"]; // Set DB value only
                Status.DbValue = (ConvertToBool(row["Status"]) ? "1" : "0"); // Set DB value only
                Incident.DbValue = row["Incident"]; // Set DB value only
                ...
                UpdatedByUserID.DbValue = row["UpdatedByUserID"]; // Set DB value only
                Perbaikan.DbValue = (ConvertToBool(row["Perbaikan"]) ? "1" : "0"); // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "Cctv2View"))
                return Language.Phrase("View");
            else if (SameString(pageName, "Cctv2Edit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "Cctv2Add"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "Cctv2View",
                Config.ApiAddAction => "Cctv2Add",
                Config.ApiEditAction => "Cctv2Edit",
                Config.ApiDeleteAction => "Cctv2Delete",
                Config.ApiListAction => "Cctv2List",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "Cctv2List";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("Cctv2View", parm);
            else
                url = KeyUrl("Cctv2View", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "Cctv2Add";
        ...
        {
            string url = "";
            url = KeyUrl("Cctv2Edit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("Cctv2List", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("Cctv2Add", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("Cctv2List", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("Cctv2Delete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            ID.SetDbValue(dr["ID"]);
            Code.SetDbValue(dr["Code"]);
            _Name.SetDbValue(dr["Name"]);
            Loc.SetDbValue(dr["Loc"]);
            Status.SetDbValue(ConvertToBool(dr["Status"]) ? "1" : "0");
            Incident.SetDbValue(dr["Incident"]);
            ...
            UpdatedByUserID.SetDbValue(dr["UpdatedByUserID"]);
            Perbaikan.SetDbValue(ConvertToBool(dr["Perbaikan"]) ? "1" : "0");
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "Cctv2List";
